...
function SocialIcon({ id, className }) {
  const paths = {
    ...
    discord: "M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.027c.5-5.188-.206-9.67-3.542-13.654a.072.072 0 0 0-.033-.027zM8.864 15.15c-1.274 0-2.323-1.168-2.323-2.601 0-1.432 1.026-2.601 2.323-2.601 1.308 0 2.356 1.181 2.323 2.601 0 1.433-1.026 2.601-2.323 2.601zm6.344 0c-1.274 0-2.323-1.168-2.323-2.601 0-1.432 1.026-2.601 2.323-2.601 1.308 0 2.356 1.181 2.323 2.601 0 1.433-1.026 2.601-2.323 2.601z", 
        ...
        {socials.map((s, i) => (
          <React.Fragment key={s.id}>
            <a
              ...
              className="text-overlay1 hover:text-accent transition-colors focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none rounded p-1"
            >
